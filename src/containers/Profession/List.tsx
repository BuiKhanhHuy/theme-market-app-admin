    ...
    <Card title="Professions">
      <div style={{ minHeight: 360, background: colorBgContainer }}>
        <div>
          ...
          <TableHeaderAction addLink='/profession/add' idList={selectedRowKeys} onDeleteMany={handleDeleteMany} onExport={handleExport} />
          {/* End: TableHeaderAction */}

          <div style={{ marginTop: 20, marginBottom: 15 }}>
            <Collapse
              items={[{
                key: 'FILTER', label: 'Filter', children:  <ProfessionFilterForm onSubmit={(data) => {console.log(data)}}/>
              }]}
            />
          </div>
