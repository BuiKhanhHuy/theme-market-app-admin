    ...
    <Card title="Categories">
      <div style={{ minHeight: 360, background: colorBgContainer }}>
        <div>
          ...
          <TableHeaderAction addLink='/tag/add' idList={selectedRowKeys} onDeleteMany={handleDeleteMany} onExport={handleExport} />
          {/* End: TableHeaderAction */}

          <div style={{ marginTop: 20, marginBottom: 15 }}>
            <Collapse
              items={[{
                key: 'FILTER', label: 'Filter', children: <TagFilterForm onSubmit={(data) => { console.log(data) }} />
              }]}
            />
          </div>
